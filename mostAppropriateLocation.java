...
public class mostAppropriateLocation {	
	 ...
	 public static void main(String args[]) throws Exception {
		 ...
		 Statement stmt = null;
		 ResultSet rs = null;
		 conn = DriverManager.getConnection("jdbc:oracle:thin:@onecore.myds.me:1521:xe", "axk159830", "axk159830");
		 
		   // conn = java.sql.DriverManager.getConnection( "jdbc:odbc:Driver={Microsoft Excel Driver(*.xls)};DBQ=C:/Users/himan/Desktop/WorkSpace/copart_Locations.xls");
